  ...
  describe ".other_users" do
    context "when there are no other users" do
      it "does not return users" do
        current_user = FactoryGirl.find_or_create(:user_john)
    ...
    context "when there are other users" do
      let(:other_users) {
        [FactoryGirl.find_or_create(:user_bart), FactoryGirl.find_or_create(:user_homer),
         FactoryGirl.find_or_create(:user_lisa), FactoryGirl.find_or_create(:user_maggie),
